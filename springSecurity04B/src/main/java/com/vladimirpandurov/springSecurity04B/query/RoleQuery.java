...
public class RoleQuery {
    ...
    public static final String SELECT_ROLE_BY_USER_ID_QUERY = "SELECT r.id, r.name, r.permission FROM Roles r JOIN UserRoles ur ON ur.role_id JOIN Users u ON u.id = ur.user_id WHERE u.id = :userId";
}
